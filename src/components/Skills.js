...
const skills = [
  ...
  { icon: <FaReact />, title: 'React', description: 'Hooks, Context API, Redux, React Router' },
  { icon: <FaNodeJS />, title: 'NodeJS ', description: 'REST APIs, Authentication, Server-side Development' },
